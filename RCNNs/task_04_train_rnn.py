...
class RNNModel(nn.Module):
    def __init__(self, input_size, hidden_size, embedding_layer, rnn_cell_type, dropout, bidirectional, no_of_layers):
...
def main(args):
    ...
    text_vocab = Vocab(text_frequencies) # Full vocab size 14806
    # pdb.set_trace()
    ...
    model = RNNModel(input_size, hidden_size, embedding_layer, rnn_cell_type=rnn_cell_type, dropout=dropout, bidirectional=bidirectional, no_of_layers=no_of_layers)
...
if __name__ == '__main__':
    ...
    if args['record']:
        ...
        name=f"l_3_h_s_250_dp_0.2_bidi_true_with_vocab_size_8000", 
